...
public class PlayerControl : MonoBehaviour
{
	...
	[HideInInspector]
	public static bool j = false;				// Condition for whether the player should jump.
    ...
    void Awake()
	{
        ...
        player1name = GameObject.Find("Score");
        player1name.GetComponent<GUIText>().text = name;

        GameObject left = GameObject.Find("leftwall");
        x2 = left.transform.position.x;
        GameObject right = GameObject.Find("rightwall");
        x4 = right.transform.position.x;
    }
